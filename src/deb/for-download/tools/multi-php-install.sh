...
if [ "$check_grep" -eq 1 ]; then
    echo "Multi-PHP support is only for Vesta that is installed in nginx+Apache or Apache variant"
    exit 1
fi
...
if [ "$inst_56" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-56.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-56.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-56.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-56.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-56.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-56.sh
    chmod a+x /usr/local/vesta/data/templates/web/apache2/PHP-FPM-56.sh
    mkdir -p /root/vesta-temp-dl/vesta/patch
    wget -nv https://c.cpvesta.ru/tools/patches/php5.6.patch -O /root/vesta-temp-dl/vesta/patch/php5.6.patch
...
if [ "$inst_70" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-70.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-70.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-70.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-70.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-70.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-70.sh
...
if [ "$inst_71" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-71.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-71.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-71.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-71.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-71.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-71.sh
...
if [ "$inst_72" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-72.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-72.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-72.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-72.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-72.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-72.sh
...
if [ "$inst_73" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-73.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-73.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-73.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-73.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-73.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-73.sh
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-73-public.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-73-public.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-73-public.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-73-public.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-73-public.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-73-public.sh
...
if [ "$inst_74" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-74.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-74.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-74.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-74.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-74.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-74.sh
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-74-public.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-74-public.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-74-public.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-74-public.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-74-public.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-74-public.sh
...
if [ "$inst_80" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-80.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-80.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-80.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-80.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-80.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-80.sh
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-80-public.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-80-public.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-80-public.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-80-public.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-80-public.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-80-public.sh
    ...
    wget -nv https://c.cpvesta.ru/tools/patches/php8.0.patch -O /root/php8.0.patch
...
if [ "$inst_81" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-81.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-81.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-81.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-81.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-81.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-81.sh
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-81-public.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-81-public.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-81-public.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-81-public.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-81-public.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-81-public.sh
    ...
    wget -nv https://c.cpvesta.ru/tools/patches/php8.1.patch -O /root/php8.1.patch
...
if [ "$inst_82" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-82.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-82.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-82.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-82.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-82.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-82.sh
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-82-public.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-82-public.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-82-public.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-82-public.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-82-public.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-82-public.sh
    ...
    wget -nv https://c.cpvesta.ru/tools/patches/php8.2.patch -O /root/php8.2.patch
...
if [ "$inst_83" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-83.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-83.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-83.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-83.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-83.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-83.sh
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-83-public.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-83-public.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-83-public.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-83-public.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-83-public.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-83-public.sh
    ...
    wget -nv https://c.cpvesta.ru/tools/patches/php8.2.patch -O /root/php8.3.patch
...
if [ "$inst_84" -eq 1 ]; then
    ...
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-84.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-84.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-84.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-84.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-84.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-84.sh
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-84-public.stpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-84-public.stpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-84-public.tpl -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-84-public.tpl
    wget -nv https://c.cpvesta.ru/tools/apache-fpm-tpl/PHP-FPM-84-public.sh -O /usr/local/vesta/data/templates/web/apache2/PHP-FPM-84-public.sh
    ...
    wget -nv https://c.cpvesta.ru/tools/patches/php8.2.patch -O /root/php8.4.patch
...
if [ -f "/usr/local/bin/tailf_apache_error.php" ]; then
    ...
    wget -nv http://dl.cpvesta.ru/vesta/tailf.php -O /usr/local/bin/tailf.php
    wget -nv http://dl.cpvesta.ru/vesta/tailf_apache_error.php -O /usr/local/bin/tailf_apache_error.php
    wget -nv http://dl.cpvesta.ru/vesta/see-apache-processlist-once.sh -O /usr/local/bin/see-apache-processlist-once.sh
    wget -nv http://dl.cpvesta.ru/vesta/see-mysql-processlist-once.sh -O /usr/local/bin/see-mysql-processlist-once.sh
